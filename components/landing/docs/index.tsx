    ...
    <section id="docs" className="max-h-screen min-h-screen mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 px-6 py-5 max-w-8xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600">
            To get started with PAI ChatBot, simply sign up for an account and
            follow the onboarding process. Once you're set up, you can start
            using the chatbot to assist your customers.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600">
            PAI ChatBot offers a range of features including natural language
            processing, multi-channel support, and customizable responses.
            Explore the documentation to learn more about each feature and how
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-600">
            The PAI ChatBot API allows you to integrate the chatbot into your
            own applications. Refer to the API documentation for detailed
            information on endpoints, request/response formats, and
            authentication.
          </p>
        </div>
          ...
          <div className="bg-[#0f0f0f] px-4 space-y-4 p-2 border border-gray-700 w-full rounded-lg shadow-lg flex flex-col items-start animate-float animation-delay-4000 h-60">
            <div className="flex w-full p-3 rounded-t-md items-center mb-2">
              ...
              <Copy
                ...
                className="ml-auto text-gray-400 cursor-pointer hover:text-gray-200 transition-colors duration-200"
                size={18}
              />
              {copy && (
