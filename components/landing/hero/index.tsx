...
const Hero = () => {
  return (
    <section id="hero" className="relative bg-gradient-to-r from-[#050508] via-[#1a1a1a] to-[#050508] overflow-hidden pb-20 pt-30 md:pt-40 md:pb-30 px-6">
        <div className="max-w-4xl mx-auto relative z-20 text-center">
            <div className='flex flex-col items-center px-3 py-1 mb-6 animate-float animation-delay-2000'>
                ...
                <h1 style={{ fontFamily: 'Acorn' }} className='text-4xl md:text-5xl font-bold text-gray-400 mb-6'>Powered by AI</h1>
                <span className="text-sm font-medium text-gray-300">
                    Experience the future of communication with our advanced AI technology.
                </span>
                <span className="text-xs font-medium text-gray-300 border border-gray-500 rounded-full px-3 py-1 mt-4 animate-pulse">
